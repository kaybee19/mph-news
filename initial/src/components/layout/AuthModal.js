    	...
    	<div className={classes.modalClass}>
          ...
          >
            ...
            <span style={{ display: 'flex', flexDirection: 'column', textAlign: 'center', fontWeight: 'bold', marginTop: '.5rem' }}>
      				<Link className={classes.buttonClass} onClick={handleSignup}>Create an account</Link>
              <Modal
              ...
              >
                <Fade in={open}><SignupModal /></Fade>
      				...
      				<Link className={classes.buttonClass} style={{ marginLeft: 'auto' }} to="/reset-password">Forgot your passowrd?</Link>
      			</span>
          </form>
    	</div>
  );
