...
import logo from '../../images/logoMPH.png'
	...
	return (
		<div className={classes.gridCont}>
			<Container maxWidth="lg">
				<Grid container>
					<Grid item md={6}>
						<img src={logo} alt="mph-logo-white" className={classes.footerLogo} />
					...
					<Grid container className={classes.listCont} item md={6}>
						<Grid item xs={6} md={4}>
							<ul className="listFooter">
								<li>
									<Typography variant="caption"><Link to='/' className={classes.linkClass}>Home</Link></Typography>
								</li>
								<li>
									<Typography variant="caption"><Link to='/about' className={classes.linkClass}>About</Link></Typography>
								</li>
								<li>
									<Typography variant="caption"><Link to='/contact' className={classes.linkClass}>Contact</Link></Typography>
								</li>
							</ul>
						</Grid>
						<Grid item xs={6} md={4}>
							<ul className="listFooter">
								<li>
									<Typography variant="caption"><Link to='/disclaimer' className={classes.linkClass}>Disclaimer</Link></Typography>
						 		</li>
								<li>
									<Typography variant="caption"><Link to='/privacy' className={classes.linkClass}>Privacy Policy</Link></Typography>
								</li>
							</ul>
						</Grid>
