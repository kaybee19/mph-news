		...
		<Grid xs={12} md={4} className={classes.subClass}>
	        ...
	        InputProps={{
		  	...
		  	/>
				...
				<Typography variant='body1'>Do you have info to share with our team?<br /><Link className={classes.linkClass} style={{ textDecoration: 'underline' }} to='/contact'>Here's</Link> how you can reach us.</Typography>
			</span>
			}
		</Grid>
	);
